...
//
// This application drives a panel that carries a file across an air gap as light. That is the work of
// a measurement instrument — a spectrum analyser, a scope, a bench meter — and the interface people
// actually trust for that work looks nothing like a web dashboard. It is dark because it shares a room with the
// panel it is driving, and a pale interface beside a frame being photographed spills light into the
// shot and ruins the very capture it is meant to help. It is dense because every figure here is evidence and hiding evidence behind whitespace
