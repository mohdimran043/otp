...
// failure means this page cannot reach the receiver, which is worth saying plainly rather than showing as a
// mysterious empty panel. Anything else is the receiver's own fault and says so.
export function ErrorNotice({ error }: { error: unknown }) {
  ...
  return (
    <Alert severity="error" sx={{ my: 2 }}>
      <AlertTitle>Cannot reach the receiver</AlertTitle>
